...
namespace RPNL.Net.Utilities.PermissionUtils
{
    ...
    {
        public PermissionDisplay(string groupName, string name, string description, PermissionsEnum permission
            /*string moduleName*/)
        {
        ...
        public static List<PermissionDisplay> GetPermissionsToDisplay(Type enumType)
        {
            ...
            foreach (var permissionName in Enum.GetNames(enumType))
            {
                ...
                var permission = (PermissionsEnum)Enum.Parse(enumType, permissionName, false);
